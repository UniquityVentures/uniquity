...
func pageEntriesVideoMenus() []registry.Pair[string, components.PageInterface] {
	return []registry.Pair[string, components.PageInterface]{
		{Key: "video.MainMenu", Value: &components.SidebarMenu{
		...
		{Key: "video.EditedDetailMenu", Value: detailMenu("editedVideo", "Edited video", "video.EditedListRoute", "video.EditedDetailRoute", "video.EditedUpdateRoute")},
		{Key: "video.PublishedDetailMenu", Value: publishedDetailMenu()},
	}
}
...
func pageEntriesRawPages() []registry.Pair[string, components.PageInterface] {
	...
	return []registry.Pair[string, components.PageInterface]{
		...
		{Key: "video.RawFootageDeleteForm", Value: &components.Modal{
		...
		{Key: "video.RawFootageSelectionTable", Value: &components.Modal{
		...
		{Key: "video.EmployeeSelectionTable", Value: &components.Modal{
...
func pageEntriesEditedPages() []registry.Pair[string, components.PageInterface] {
	...
	return []registry.Pair[string, components.PageInterface]{
		...
		{Key: "video.EditedVideoDeleteForm", Value: &components.Modal{
		...
		{Key: "video.EditedVideoSelectionTable", Value: &components.Modal{
...
func pageEntriesPublishedPages() []registry.Pair[string, components.PageInterface] {
	...
	return []registry.Pair[string, components.PageInterface]{
		...
		{Key: "video.PublishedVideoDeleteForm", Value: &components.Modal{
						...
						&components.FormComponent[uniqempl.PointsTransaction]{
							...
							ChildrenInput: []components.PageInterface{
								...
								&components.InputPointsDecimal{
									...
									Name:     "Points",
									Required: true,
									Getter:   getters.Key[fields.DecimalSix]("$in.Points"),
								},
							},
							ChildrenAction: []components.PageInterface{
		...
		{Key: "video.PublishedVideoSelectionTable", Value: &components.Modal{
